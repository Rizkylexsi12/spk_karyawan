                            ...
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <div class="card-body pt-1">
                                        <p class="card-text">
											Sistem Penunjang Keputusan merupakan suatu sistem informasi spesifik yang dirancang untuk membantu manajemen dalam
											pengambilan keputusan yang berkaitan dengan persoalan yang bersifat semi terstruktur dengan menggunakan data, model,
											dan alat analisis. Simple Additive Weighting (SAW) digunakan dalam sistem penunjang keputusan untuk menghitung nilai
											preferensi relatif dari sejumlah alternatif berdasarkan beberapa kriteria.
										</p>
											Metode SAW mengubah semua kriteria dan bobot yang terkait menjadi skala nilai relatif, dan kemudian menggabungkan skala
											nilai tersebut untuk menghasilkan skor akhir yang menunjukkan peringkat atau preferensi relatif dari setiap alternatif.
											Konsep dasar pada metode SAW adalah mencari penjumlahan terbobot dari rating kinerja pada setiap alternatif di semua atribut.
                                        </p>
                                        <hr>
                                        <p class="card-text">
